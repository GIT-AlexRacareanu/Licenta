...
public class EvaluatorProfileFragment extends Fragment {

    private User user;

    public static EvaluatorProfileFragment newInstance(User user) {
        EvaluatorProfileFragment fragment = new EvaluatorProfileFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.evaluator_profile_fragment, container, false);
    }
